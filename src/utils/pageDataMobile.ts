...
const data = {
  ...
  [PageEnum.OurProduct]: {
    ...
    products: [
      {
        logo: '/image/mobile/product-title1.png',
        bg: '/image/mobile/bg.png',
        title: '若琪看看',
        value: 1,
        description:
      ...
      {
        logo: '/image/mobile/product-title2.png',
        bg: '/image/mobile/product-bg1.png',
        title: '若琪看看',
        value: 2,
        description:
          '围绕 AR 设备＋云端＋小程序，构建的一站式 AR 智慧导览平台，助力文博文旅等场景打造虚实融合、乐趣横生的导览体验。',
      ...
      {
        logo: '/image/mobile/product-title3.png',
        bg: '/image/mobile/bg.png',
        title: '若琪看看',
        value: 3,
        description:
    ...
    cases: [
      {
        ...
        children: [
          {
            bg: '/image/mobile/industry-case-bg1.png',
            title: '上海自然博物馆',
            description:
  ...
  [HomeTabEnum.Product]: {
    ...
    otherProduct: {
      ...
      children: [
        {
          image: '/image/pc/industry-case-bg1.png',
          icon: '/image/pc/product/product-icon1.png',
          title: '乐奇玩玩',
          subTitle: '互娱产品集合体',
        },
